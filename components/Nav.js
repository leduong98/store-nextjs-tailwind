...
export default function Nav({show}) {
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-purple-50 h-full md:static md:w-auto md:h-full transition-all"}>
      <div className="mb-4 mr-4 rounded-lg bg-purple-100 px-4 py-3">
        <Logo />
      </div>
